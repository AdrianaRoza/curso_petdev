...
const testimonials = [
  ...
  {
    content: "Gratidão por sempre deixarem meu pet lindo e saudável. Recomendo o trabalho de vocês de olhos fechados Vocês são mais do que um petshop, são uma família para nossos bichinhos! Obrigada por todo o cuidado.",
